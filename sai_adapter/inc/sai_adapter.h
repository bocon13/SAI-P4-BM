...
public:
  ...
  boost::shared_ptr<TTransport> router_socket; // boc: remove
  boost::shared_ptr<TTransport> router_transport; // boc: remove
  boost::shared_ptr<TProtocol> router_bprotocol; // boc: remove
  boost::shared_ptr<TProtocol> router_protocol; // boc: remove
  StandardClient bm_bridge_client;
  StandardClient bm_router_client; // boc: remove
  SimplePreLAGClient bm_bridge_client_mc;
  std::shared_ptr<::grpc::ChannelInterface> router_channel;
  // generals
  ...
  static StandardClient *bm_router_client_ptr; // boc: remove
  static SimplePreLAGClient *bm_bridge_client_mc_ptr;
  static Switch_metadata *switch_metadata_ptr;
  //static std::unique_ptr<::gnmi::gNMI::Stub> router_gnmi_stub;
  //static std::unique_ptr<::p4::v1::P4Runtime::Stub> router_p4rt_stub;
  // static ::gnmi::gNMI::Stub *router_gnmi_stub;
  // static ::p4::v1::P4Runtime::Stub *router_p4rt_stub;
...
// saiport.h
  ...
  static sai_status_t get_parsed_port_attribute(Port_obj *port,
                                        sai_attribute_t *attribute);
  static sai_status_t get_port_stats(sai_object_id_t port_id, uint32_t number_of_counters, const sai_stat_id_t *counter_ids, uint64_t *counters);
  static sai_status_t get_port_stats_ext(
            sai_object_id_t port_id,
            uint32_t number_of_counters,
            const sai_stat_id_t *counter_ids,
            sai_stats_mode_t mode,
            uint64_t *counters);
  static sai_status_t clear_port_stats(
            sai_object_id_t port_id,
            uint32_t number_of_counters,
            const sai_stat_id_t *counter_ids);
  static sai_status_t clear_port_all_stats(
            sai_object_id_t port_id);
  static sai_status_t create_port_pool(
            sai_object_id_t *port_pool_id,
            sai_object_id_t switch_id,
            uint32_t attr_count,
            const sai_attribute_t *attr_list);
  static sai_status_t remove_port_pool(
            sai_object_id_t port_pool_id);
  static sai_status_t set_port_pool_attribute(
            sai_object_id_t port_pool_id,
            const sai_attribute_t *attr);
  static sai_status_t get_port_pool_attribute(
            sai_object_id_t port_pool_id,
            uint32_t attr_count,
            sai_attribute_t *attr_list);
  static sai_status_t get_port_pool_stats(
            sai_object_id_t port_pool_id,
            uint32_t number_of_counters,
            const sai_stat_id_t *counter_ids,
            uint64_t *counters);
  static sai_status_t get_port_pool_stats_ext(
            sai_object_id_t port_pool_id,
            uint32_t number_of_counters,
            const sai_stat_id_t *counter_ids,
            sai_stats_mode_t mode,
            uint64_t *counters);
  static sai_status_t clear_port_pool_stats(
            sai_object_id_t port_pool_id,
            uint32_t number_of_counters,
            const sai_stat_id_t *counter_ids);
  static sai_status_t create_port_serdes(
            sai_object_id_t *port_serdes_id,
            sai_object_id_t switch_id,
            uint32_t attr_count,
            const sai_attribute_t *attr_list);
  static sai_status_t remove_port_serdes(
            sai_object_id_t port_serdes_id);
  static sai_status_t set_port_serdes_attribute(
            sai_object_id_t port_serdes_id,
            const sai_attribute_t *attr);
  static sai_status_t get_port_serdes_attribute(
            sai_object_id_t port_serdes_id,
            uint32_t attr_count,
            sai_attribute_t *attr_list);
...
// saifdb.h
  ...
  static sai_status_t set_fdb_entry_attribute(
            const sai_fdb_entry_t *fdb_entry,
            const sai_attribute_t *attr);
  static sai_status_t get_fdb_entry_attribute(
            const sai_fdb_entry_t *fdb_entry,
            uint32_t attr_count,
            sai_attribute_t *attr_list);
...
// saivlan.h
  ...
  static sai_status_t get_vlan_stats(sai_object_id_t vlan_id,
                                     ...
                                     const sai_stat_id_t *counter_ids,
                                     uint64_t *counters);
  static sai_status_t get_vlan_stats_ext(
  ...
  static sai_status_t clear_vlan_stats(sai_object_id_t vlan_id,
                                       uint32_t number_of_counters,
                                       const sai_stat_id_t *counter_ids);
  static sai_status_t create_vlan_members(sai_object_id_t switch_id,uint32_t object_count,uint32_t *attr_count,const sai_attribute_t **attrs,sai_bulk_op_error_mode_t type,sai_object_id_t *object_id,sai_status_t *object_statuses);

  static sai_status_t remove_vlan_members(uint32_t object_count,const sai_object_id_t *object_id,sai_bulk_op_error_mode_t type,sai_status_t *object_statuses);
...
// saivirtualrouter.h
  static sai_status_t create_virtual_router (sai_object_id_t *virtual_router_id,
                                            sai_object_id_t switch_id,
                                            uint32_t attr_count,
                                            const sai_attribute_t *attr_list);
  static sai_status_t remove_virtual_router(sai_object_id_t virtual_router_id);
  static sai_status_t set_virtual_router_attribute(sai_object_id_t virtual_router_id, const sai_attribute_t *attr);
  static sai_status_t get_virtual_router_attribute(sai_object_id_t virtual_router_id, uint32_t attr_count, sai_attribute_t *attr_list);
// sairouterinterface.h
  static sai_status_t create_router_interface (sai_object_id_t *router_interface_id,
                                            sai_object_id_t switch_id,
                                            uint32_t attr_count,
                                            const sai_attribute_t *attr_list);
  static sai_status_t remove_router_interface (sai_object_id_t router_interface_id);
  static sai_status_t set_router_interface_attribute(sai_object_id_t router_interface_id, const sai_attribute_t *attr);
  static sai_status_t get_router_interface_attribute(sai_object_id_t router_interface_id, uint32_t attr_count, sai_attribute_t *attr_list);
  static sai_status_t get_router_interface_stats(
            sai_object_id_t router_interface_id,
            uint32_t number_of_counters,
            const sai_stat_id_t *counter_ids,
            uint64_t *counters);
  static sai_status_t get_router_interface_stats_ext(
            sai_object_id_t router_interface_id,
            uint32_t number_of_counters,
            const sai_stat_id_t *counter_ids,
            sai_stats_mode_t mode,
            uint64_t *counters);
  static sai_status_t clear_router_interface_stats(
            sai_object_id_t router_interface_id,
            uint32_t number_of_counters,
            const sai_stat_id_t *counter_ids);
// saineighbor.h
...
// sairoute.h
  ...
  static sai_status_t set_route_entry_attribute(
            const sai_route_entry_t *route_entry,
            const sai_attribute_t *attr);
  static sai_status_t get_route_entry_attribute(
            const sai_route_entry_t *route_entry,
            uint32_t attr_count,
            sai_attribute_t *attr_list);
  static sai_status_t create_route_entries(
  ...
  static sai_status_t remove_route_entries(
            uint32_t object_count,
            const sai_route_entry_t *route_entry,
            sai_bulk_op_error_mode_t mode,
            sai_status_t *object_statuses);
  static sai_status_t set_route_entries_attribute(
            uint32_t object_count,
            const sai_route_entry_t *route_entry,
            const sai_attribute_t *attr_list,
            sai_bulk_op_error_mode_t mode,
            sai_status_t *object_statuses);
  static sai_status_t get_route_entries_attribute(
            uint32_t object_count,
            const sai_route_entry_t *route_entry,
            const uint32_t *attr_count,
            sai_attribute_t **attr_list,
...
// saipolicer.h
  ...
  static sai_status_t get_policer_stats(sai_object_id_t policer_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,uint64_t *counters);
  static sai_status_t get_policer_stats_ext(sai_object_id_t policer_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,sai_stats_mode_t mode,uint64_t *counters);
  static sai_status_t clear_policer_stats(sai_object_id_t policer_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids);
// saimirror.h
  static sai_status_t create_mirror_session(sai_object_id_t *mirror_session_id,sai_object_id_t switch_id,uint32_t attr_count,const sai_attribute_t *attr_list);
  static sai_status_t remove_mirror_session(sai_object_id_t mirror_session_id);
  static sai_status_t set_mirror_session_attribute(sai_object_id_t mirror_session_id,const sai_attribute_t *attr);
  static sai_status_t get_mirror_session_attribute(sai_object_id_t mirror_session_id,uint32_t attr_count,sai_attribute_t *attr_list);
// saistp.h
  ...
  static sai_status_t create_stp_ports(sai_object_id_t switch_id,uint32_t object_count,const uint32_t *attr_count,const sai_attribute_t **attrs,sai_bulk_op_error_mode_t type,sai_object_id_t *object_id,sai_status_t *object_statuses);
  static sai_status_t remove_stp_ports(uint32_t object_count,const sai_object_id_t *object_id,sai_bulk_op_error_mode_t type,sai_status_t *object_statuses);
// saisamplepacket.h
...
// saiqueue.h
  ...
  static sai_status_t get_queue_stats(sai_object_id_t queue_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,uint64_t *counters);
  static sai_status_t get_queue_stats_ext(sai_object_id_t queue_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,sai_stats_mode_t mode,uint64_t *counters);
  static sai_status_t clear_queue_stats(sai_object_id_t queue_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids);
// saischedulergroup.h
...
// saitunnel.h
  ...
  static sai_status_t get_tunnel_stats(sai_object_id_t tunnel_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,uint64_t *counters);
  static sai_status_t get_tunnel_stats_ext(sai_object_id_t tunnel_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,sai_stats_mode_t mode,uint64_t *counters);
  static sai_status_t clear_tunnel_stats(sai_object_id_t tunnel_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids);
...
// saimcastfdb.h
  static sai_status_t create_mcast_fdb_entry(const sai_mcast_fdb_entry_t *mcast_fdb_entry,uint32_t attr_count,const sai_attribute_t *attr_list);
  static sai_status_t remove_mcast_fdb_entry(const sai_mcast_fdb_entry_t *mcast_fdb_entry);
  static sai_status_t set_mcast_fdb_entry_attribute(const sai_mcast_fdb_entry_t *mcast_fdb_entry,const sai_attribute_t *attr);
  static sai_status_t get_mcast_fdb_entry_attribute(const sai_mcast_fdb_entry_t *mcast_fdb_entry,uint32_t attr_count,sai_attribute_t *attr_list);
// saibuffer.h
  static sai_status_t create_buffer_pool(sai_object_id_t *buffer_pool_id,sai_object_id_t switch_id,uint32_t attr_count,const sai_attribute_t *attr_list);
  static sai_status_t remove_buffer_pool(sai_object_id_t buffer_pool_id);
  static sai_status_t set_buffer_pool_attribute(sai_object_id_t buffer_pool_id,const sai_attribute_t *attr);
  static sai_status_t get_buffer_pool_attribute(sai_object_id_t buffer_pool_id,uint32_t attr_count,sai_attribute_t *attr_list);
  static sai_status_t get_buffer_pool_stats(sai_object_id_t buffer_pool_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,uint64_t *counters);
  static sai_status_t get_buffer_pool_stats_ext(sai_object_id_t buffer_pool_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,sai_stats_mode_t mode,uint64_t *counters);
  static sai_status_t clear_buffer_pool_stats(sai_object_id_t buffer_pool_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids);
  static sai_status_t create_ingress_priority_group(sai_object_id_t *ingress_priority_group_id,sai_object_id_t switch_id,uint32_t attr_count,const sai_attribute_t *attr_list);
  static sai_status_t remove_ingress_priority_group(sai_object_id_t ingress_priority_group_id);
  static sai_status_t set_ingress_priority_group_attribute(sai_object_id_t ingress_priority_group_id,const sai_attribute_t *attr);
  static sai_status_t get_ingress_priority_group_attribute(sai_object_id_t ingress_priority_group_id,uint32_t attr_count,sai_attribute_t *attr_list);
  static sai_status_t get_ingress_priority_group_stats(sai_object_id_t ingress_priority_group_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,uint64_t *counters);
  static sai_status_t get_ingress_priority_group_stats_ext(sai_object_id_t ingress_priority_group_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids,sai_stats_mode_t mode,uint64_t *counters);
  static sai_status_t clear_ingress_priority_group_stats(sai_object_id_t ingress_priority_group_id,uint32_t number_of_counters,const sai_stat_id_t *counter_ids);
